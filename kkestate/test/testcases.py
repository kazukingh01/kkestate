...
TEST_CASES_ADDRESS_SIMPLE = [
    ...
    {"input": "千葉県我孫子市柴崎台３-16-23頭金なし「物件価格+諸費用+おまとめ", "expected": {"location": "千葉県我孫子市柴崎台３-16-23", 'citycode': "12222"}},
    {"input": "千葉県柏市柏の葉５-7-23月25日価格更新！頭金なし「物件価格+諸費用+おまとめ（マイカー", "expected": {"citycode":"12217","location":"千葉県柏市柏の葉５-7-2"}},
    {"input": "千葉県柏市柏の葉５-7-2 3月25日価格更新！頭金なし「物件価格+諸費用+おまとめ（マイカー、ショッピングローン等", "expected": {'citycode': '12217', "location": "千葉県柏市柏の葉５-7-2"}},
]
...
TEST_CASES_FEATURE_PICKUP = [
    {"input":"エレベーター","expected":{"feature_tags":["エレベーター"],"feature_count":1}},
    {"input":"土地50坪以上","expected":{"feature_tags":["土地50坪以上"],"feature_count":1}},
    {"input":"スーパー 徒歩10分以内      /       小学校 徒歩10分以内     /       エレベーター","expected":{"feature_tags":["スーパー 徒歩10分以内","小学校 徒歩10分以内","エレベーター"],"feature_count":3}},
    {"input":"角住戸     /       エレベーター","expected":{"feature_tags":["角住戸","エレベーター"],"feature_count":2}},
    {"input":"セキュリティ充実   /       エレベーター","expected":{"feature_tags":["セキュリティ充実","エレベーター"],"feature_count":2}},
    {"input":"土地50坪以上       /       スーパー 徒歩10分以内   /       システムキッチン        /       全居室収納      /       ＬＤＫ１５畳以上        /  整形地  /       対面式キッチン  /       ２階建","expected":{"feature_tags":["土地50坪以上","スーパー 徒歩10分以内","システムキッチン","全居室収納","ＬＤＫ１５畳以上","整形地","対面式キッチン","２階建"],"feature_count":8}},
    {"input":"長期優良住宅認定通知書       /       建設住宅性能評価書（新築時）    /       フラット３５・S適合証明書       /       省エネルギー対策        /       駐車２台可  /       ＬＤＫ２０畳以上        /       省エネ給湯器    /       スーパー 徒歩10分以内  /       システムキッチン        /       浴室乾燥機      /       陽当り良好      /       全居室収納      /       閑静な住宅地    /       前道６ｍ以上        /       和室    /       シャワー付洗面化粧台    /       対面式キッチン  /       トイレ２ヶ所    /       浴室１坪以上        /       ２階建  /       東南向き        /       複層ガラス      /       オートバス      /       温水洗浄便座    /       床下収納        /       浴室に窓        /       吹抜け  /       ＴＶモニタ付インターホン        /       通風良好        /       ウォークインクローゼット        /       シューズインクローク        /       平坦地  /       食器洗乾燥機    /       整備された歩道  /       浄水器","expected":{"feature_tags":["長期優良住宅認定通知書","建設住宅性能評価書（新築時）","フラット３５・S適合証明書","省エネルギー対策","駐車２台可","ＬＤＫ２０畳以上","省エネ給湯器","スーパー 徒歩10分以内","システムキッチン","浴室乾燥機","陽当り良好","全居室収納","閑静な住宅地","前道６ｍ以上","和室","シャワー付洗面化粧台","対面式キッチン","トイレ２ヶ所","浴室１坪以上","２階建","東南向き","複層ガラス","オートバス","温水洗浄便座","床下収納","浴室に窓","吹抜け","ＴＶモニタ付インターホン","通風良好","ウォークインクローゼット","シューズインクローク","平坦地","食器洗乾燥機","整備された歩道","浄水器"],"feature_count":35}},
    {"input":"ペット相談 /       エレベーター","expected":{"feature_tags":["ペット相談","エレベーター"],"feature_count":2}},
    {"input":"駐車３台以上可     /       省エネ給湯器    /       南向き  /       システムキッチン        /       浴室乾燥機      /       陽当り良好      /  全居室収納      /       閑静な住宅地    /       ＬＤＫ１５畳以上        /       角地    /       対面式キッチン  /       トイレ２ヶ所    /       浴室１坪以上    /       ２階建  /       複層ガラス      /       全室南向き      /       温水洗浄便座    /       床下収納        /  浴室に窓        /       ＴＶモニタ付インターホン        /       通風良好        /       ウォークインクローゼット        /       ＩＨクッキングヒーター      /       全居室複層ガラスか複層サッシ    /       都市ガス        /       シューズインクローク    /       食器洗乾燥機    /       浄水器      /       スマートキー","expected":{"feature_tags":["駐車３台以上可","省エネ給湯器","南向き","システムキッチン","浴室乾燥機","陽当り良好","全居室収納","閑静な住宅地","ＬＤＫ１５畳以上","角地","対面式キッチン","トイレ２ヶ所","浴室１坪以上","２階建","複層ガラス","全室南向き","温水洗浄便座","床下収納","浴室に窓","ＴＶモニタ付インターホン","通風良好","ウォークインクローゼット","ＩＨクッキングヒーター","全居室複層ガラスか複層サッシ","都市ガス","シューズインクローク","食器洗乾燥機","浄水器","スマートキー"],"feature_count":29}},
    {"input":"瑕疵保証付（不動産会社独自）","expected":{"feature_tags":["瑕疵保証付（不動産会社独自）"],"feature_count":1}},
    {"input":"最上階角住戸","expected":{"feature_tags":["最上階角住戸"],"feature_count":1}},
    {"input":"分譲時の価格帯","expected":{"feature_tags":["分譲時の価格帯"],"feature_count":1}},
    {"input":"管理人常駐","expected":{"feature_tags":["管理人常駐"],"feature_count":1}},
    {"input":"都心アクセス","expected":{"feature_tags":["都心アクセス"],"feature_count":1}},
    {"input":"古民家","expected":{"feature_tags":["古民家"],"feature_count":1}},
    {"input":"宅配ボックス       /       エレベーター","expected":{"feature_tags":["宅配ボックス","エレベーター"],"feature_count":2}},
    {"input":"駅 徒歩5分以内","expected":{"feature_tags":["駅 徒歩5分以内"],"feature_count":1}},
    {"input":"建築中","expected":{"feature_tags":["建築中"],"feature_count":1}},
    {"input":"国道沿い","expected":{"feature_tags":["国道沿い"],"feature_count":1}},
    {"input":"食器洗い機 /       ＩＨクッキングヒーター","expected":{"feature_tags":["食器洗い機","ＩＨクッキングヒーター"],"feature_count":2}},
    {"input":"床暖房","expected":{"feature_tags":["床暖房"],"feature_count":1}},
    {"input":"複数路線利用可","expected":{"feature_tags":["複数路線利用可"],"feature_count":1}},
    {"input":"リフォーム済み","expected":{"feature_tags":["リフォーム済み"],"feature_count":1}},
    {"input":"即入居可","expected":{"feature_tags":["即入居可"],"feature_count":1}},
    {"input":"公園隣接","expected":{"feature_tags":["公園隣接"],"feature_count":1}},
    {"input":"高層階","expected":{"feature_tags":["高層階"],"feature_count":1}},
    {"input":"駐車場敷地内","expected":{"feature_tags":["駐車場敷地内"],"feature_count":1}},
    {"input":"眺望良好","expected":{"feature_tags":["眺望良好"],"feature_count":1}},
    {"input":"収納豊富","expected":{"feature_tags":["収納豊富"],"feature_count":1}},
    {"input":"バリアフリー","expected":{"feature_tags":["バリアフリー"],"feature_count":1}},
]

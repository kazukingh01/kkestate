...
TEST_CASES_UNITS1 = [
    ...
    {"input": "88戸（ほか地権者用住戸18戸、店舗8区画）", "expected": {"value": 88, "unit": "戸", "additional_units": [{"value": 18, "unit": "戸", "type": "地権者用住戸"}, {"value": 8, "unit": "区画", "type": "店舗"}], "is_total": True}},
    {"input": "115戸（1階約9区画）", "expected": {"value": 115, "unit": "戸", "additional_units": [{"value": 9, "unit": "区画", "type": "1階", "is_approximate": True}], "is_total": True}},
    {"input": "134戸（1階店舗1区画）", "expected": {"value": 134, "unit": "戸", "additional_units": [{"value": 1, "unit": "区画", "type": "1階店舗"}], "is_total": True}},
...
TEST_CASES_PRICE = [
    ...
    {"input": "3980万円〜5980万円 [ □支払シミュレーション ]", "expected": {"unit": "万円", "min": 3980.0, "max": 5980.0, }},
    {"input": "価格要相談 [ □支払シミュレーション ]", "expected": {"type": "negotiable", }},
    {"input": "2980万円（参考価格）       [ □支払シミュレーション ]", "expected": {"unit": "万円", "value": 2980.0, "tentative": True, }},
    {"input": "4350万円(モデルルーム住戸につき家具家電付き)       [ □支払シミュレーション ]", "expected": {"unit": "万円", "value": 4350.0, "note": "モデルルーム住戸につき家具家電付き", }},
    {"input": "即入居可 2980万円  [ □支払シミュレーション ]", "expected": {"unit": "万円", "value": 2980.0, "immediate_available": True, }},
    {"input": "2700万円(建物価格: 1800万円 、土地価格: 900万円)   [ □支払シミュレーション ]", "expected": {"unit": "万円", "value": 2700.0, "note": "建物価格: 1800万円 、土地価格: 900万円", }},
    {"input": "8980万円〜2億880万円       [ □支払シミュレーション ]", "expected": {"unit": "万円", "min": 8980.0, "max": 20880.0, }},
]
...
TEST_CASES_MANAGEMENT_PREP_FEE = [
    ...
    {"input": "2770円～5620円（一括払い）（住宅一部管理準備金）、4380円～8880円（一括払い）（全体管理準備金）", "expected": {"note": "全体管理準備金", "min": 2770, "max": 8880, "value": 5825.0, "unit": "円", "frequency": "一括"}},
...
TEST_CASES_AREAS = [
    ...
    {"input": "ルーフバルコニー面積：25.83m2", "expected": {"areas": [{"type": "ルーフバルコニー面積", "value": 25.83, "unit": "m^2", "tsubo": 7.82}]}},
    {"input": "専用庭面積：45.6m2", "expected": {"areas": [{"type": "専用庭面積", "value": 45.6, "unit": "m^2", "tsubo": 13.8}]}},
...
TEST_CASES_PRICE_MISC = [
    {"input": "未定", "expected": {"value": None}},
    {"input": "未定※権利金含む", "expected": {"value": None}},
    {"input": "未定（※一括前払地代含む）", "expected": {"value": None}},
    {"input": "3989万5000円～4978万7000円", "expected": {"unit": "万円", "min": 3989.5, "max": 4978.7}},
    {"input": "6540万円・6990万円", "expected": {"unit": "万円", "min": 6540, "max": 6990}},
    {"input": "4430万円～1億1340万円", "expected": {"unit": "万円", "min": 4430, "max": 11340}},
    {"input": "2580万円～9800万円", "expected": {"unit": "万円", "min": 2580, "max": 9800}},
    {"input": "未定（※前払い地代含む）", "expected": {"value": None}},
    {"input": "未定（うちモデルルーム販売あり：使用期間2025年4月4日～引き渡しまで）", "expected": {"value": None}},
    {"input": "3998万円～8998万円", "expected": {"unit": "万円", "min": 3998, "max": 8998}}
]

TEST_CASES_PRICE_BAND_EXTRA = [
    {"input": "未定", "expected": {"value": None}},
    {"input": "-", "expected": {"value": None}},
    {"input": "3900万円台", "expected": {"unit": "万円", "values": [{"price": 3900, "count": 1}]}},
    {"input": "4300万円台（5戸）", "expected": {"unit": "万円", "values": [{"price": 4300, "count": 5}]}},
    {"input": "6400万円台・6700万円台・6900万円台（各1戸）", "expected": {"unit": "万円", "values": [{"price": 6400, "count": 1}, {"price": 6700, "count": 1}, {"price": 6900, "count": 1}]}},
    {"input": "4200万円台・4400万円台・4900万円台（各8戸）", "expected": {"unit": "万円", "values": [{"price": 4200, "count": 8}, {"price": 4400, "count": 8}, {"price": 4900, "count": 8}]}},
    {"input": "3800万円台・4000万円台・4100万円台・4600万円台・4800万円台・6400万円台（各4戸）", "expected": {"unit": "万円", "values": [{"price": 3800, "count": 4}, {"price": 4000, "count": 4}, {"price": 4100, "count": 4}, {"price": 4600, "count": 4}, {"price": 4800, "count": 4}, {"price": 6400, "count": 4}]}},
    {"input": "1億1000万円台※1000万円単位", "expected": {"unit": "万円", "values": [{"price": 11000, "count": 1}]}},
    {"input": "5000万円台（9戸）※1000万円単位", "expected": {"unit": "万円", "values": [{"price": 5000, "count": 9}]}},
    {"input": "4600万円台・4900万円台", "expected": {"unit": "万円", "values": [{"price": 4600, "count": 1}, {"price": 4900, "count": 1}]}}
]

TEST_CASES_PRICE_BAND2 = [
    {"input": "2700万円台～4400万円台", "expected": {"unit": "万円", "values": [{"price": 2700.0, "count": None}, {"price": 4400.0, "count": None}], "value": 3550.0, "period": 5}},
    {"input": "3700万円台～8400万円台", "expected": {"unit": "万円", "values": [{"price": 3700.0, "count": None}, {"price": 8400.0, "count": None}], "value": 6050.0, "period": 5}},
    {"input": "2900万円台・3200万円台", "expected": {"unit": "万円", "values": [{"price": 2900.0, "count": None}, {"price": 3200.0, "count": None}], "value": 3050.0, "period": 5}},
    {"input": "3900万円台", "expected": {"unit": "万円", "values": [{"price": 3900.0, "count": 1}], "value": 3900.0, "period": 5}},
    {"input": "8300万円台・9500万円台", "expected": {"unit": "万円", "values": [{"price": 8300.0, "count": None}, {"price": 9500.0, "count": None}], "value": 8900.0, "period": 5}},
    {"input": "5800万円台～9900万円台", "expected": {"unit": "万円", "values": [{"price": 5800.0, "count": None}, {"price": 9900.0, "count": None}], "value": 7850.0, "period": 5}},
    {"input": "2400万円台～6300万円台", "expected": {"unit": "万円", "values": [{"price": 2400.0, "count": None}, {"price": 6300.0, "count": None}], "value": 4350.0, "period": 5}},
    {"input": "2900万円台～4500万円台（うちモデルルーム価格4476万円、予定）", "expected": {"unit": "万円", "values": [{"price": 2900.0, "count": None}, {"price": 4500.0, "count": None}], "value": 3700.0, "period": 5}},
    {"input": "3900万円台～8300万円台（※100万円単位）", "expected": {"unit": "万円", "values": [{"price": 3900.0, "count": None}, {"price": 8300.0, "count": None}], "value": 6100.0, "period": 5}},
    {"input": "8900万円台～1億2900万円台", "expected": {"unit": "万円", "values": [{"price": 8900.0, "count": None}, {"price": 12900.0, "count": None}], "value": 10900, "period": 5}},
]

TEST_CASES_REPAIR_FUND_BASIC2 = [
    {"input": "金額未定", "expected": {"is_undefined": True, "value": None, "period": 5}},
    {"input": "106万5000円～132万3000円（一括払い）", "expected": {"min": 1065000, "max": 1323000, "value": 1194000.0, "unit": "円", "frequency": "一括", "period": 5}},
    {"input": "23万100円～33万6600円（一括払い）、修繕積立基金(住宅)：16万4400円～24万400円（一括払い）", "expected": {"note": "住宅", "min": 230100, "max": 336600, "value": 283350.0, "unit": "円", "frequency": "一括", "period": 5}},
    {"input": "57万5400円・60万3000円（一括払い）", "expected": {"min": 575400, "max": 603000, "value": 589200.0, "unit": "円", "frequency": "一括", "period": 5}},
    {"input": "75万5000円（一括払い）、全体修繕積立基金：80万6000円（一括払い）", "expected": {"value": 755000, "unit": "円", "frequency": "一括", "period": 5}},
    {"input": "36万600円～207万7800円（一括払い）", "expected": {"min": 360600, "max": 2077800, "value": 1219200.0, "unit": "円", "frequency": "一括", "period": 5}},
    {"input": "78万9840円・81万690円（一括払い）", "expected": {"min": 789840, "max": 810690, "value": 800265.0, "unit": "円", "frequency": "一括", "period": 5}},
    {"input": "24万6000円～113万8500円（一括払い）", "expected": {"min": 246000, "max": 1138500, "value": 692250.0, "unit": "円", "frequency": "一括", "period": 5}},
    {"input": "金額未定、金額未定 （団地修繕積立一時金）", "expected": {"is_undefined": True, "value": None, "period": 5}},
    {"input": "75万5000円・87万6000円（一括払い）、全体修繕積立基金：80万6000円・93万5000円（一括払い）", "expected": {"min": 755000, "max": 876000, "value": 815500.0, "unit": "円", "frequency": "一括", "period": 5}},
]

TEST_CASES_OTHER_EXPENSES2 = [
    {"input": "-", "expected": {"value": None, "period": 5}},
    {"input": "災害積立金：300円／月、災害積立基金：1万円／一括", "expected": {"expenses": [{"name": "災害積立金", "category": "災害積立", "value": 300, "unit": "円", "frequency": "月"}, {"name": "災害積立基金", "category": "災害積立", "value": 10000, "unit": "円", "frequency": "一括"}], "period": 5}},
    {"input": "インターネット接続サービス利用料：1375円／月、ロイヤルサロン使用料：650円～2110円／月", "expected": {"expenses": [{"name": "インターネット", "category": "通信費", "value": 1375, "unit": "円", "frequency": "月"}, {"name": "ロイヤルサロン使用料", "category": "利用料", "min": 650, "max": 2110, "value": 1380.0, "unit": "円", "frequency": "月"}], "period": 5}},
    {"input": "インターネット定額料金：990円／月、給湯器リース料：2200円／月、CATV利用料金：385円／月", "expected": {"expenses": [{"name": "インターネット", "category": "通信費", "value": 990, "unit": "円", "frequency": "月"}, {"name": "CATV", "category": "通信費", "value": 385, "unit": "円", "frequency": "月"}], "period": 5}},
    {"input": "管理一時金：1万6700円・2万2360円／一括、専用利用料：3080円／月(ホームセキュリティ費用、インターネットサービス利用料、プロバイダサービス料、マンションポータルサイト利用料含む)、コミュニティクラブ費：300円／月", "expected": {"expenses": [{"name": "管理一時金", "category": "管理費", "value": 16700, "unit": "円", "frequency": "月"}, {"name": "専用利用料", "category": "利用料", "value": 3080, "unit": "円", "frequency": "月"}, {"name": "コミュニティクラブ費", "category": "コミュニティ", "value": 300, "unit": "円", "frequency": "月"}], "period": 5}},
    {"input": "地代：6083円／月、地代準備金：14万5992円（一括払い）、町内会費：200円／月、インターネット定額料金：1925円／月", "expected": {"expenses": [{"name": "地代", "category": "地代", "value": 6083, "unit": "円", "frequency": "月"}, {"name": "町内会費", "category": "自治会費", "value": 200, "unit": "円", "frequency": "月"}, {"name": "インターネット", "category": "通信費", "value": 1925, "unit": "円", "frequency": "月"}], "period": 5}},
    {"input": "地代：6083円～7536円／月、地代準備金：14万5992円～18万864円（一括払い）", "expected": {"expenses": [{"name": "地代", "category": "地代", "min": 6083, "max": 7536, "value": 6809.5, "unit": "円", "frequency": "月"}], "period": 5}},
    {"input": "保証金：21万8400円～32万6400円、月払賃料：9100円～1万3600円／月、借地返還対応準備金：6090円～9130円／月、インターネット使用料：770円／月", "expected": {"expenses": [{"name": "保証金", "category": "保証金", "min": 218400, "max": 326400, "value": 272400.0, "unit": "円", "frequency": "月"}, {"name": "インターネット", "category": "通信費", "value": 770, "unit": "円", "frequency": "月"}], "period": 5}},
    {"input": "解体準備金：3300円／月、支払地代：1万614円／月、解体準備一時金：11万8800円／一括、地代保証金：25万4736円／一括、インターネット使用料：2189円／月", "expected": {"expenses": [{"name": "解体準備金", "category": "解体", "value": 3300, "unit": "円", "frequency": "月"}, {"name": "支払地代", "category": "地代", "value": 10614, "unit": "円", "frequency": "月"}, {"name": "解体準備一時金", "category": "解体", "value": 118800, "unit": "円", "frequency": "一括"}, {"name": "地代保証金", "category": "保証金", "value": 254736, "unit": "円", "frequency": "一括"}, {"name": "インターネット", "category": "通信費", "value": 2189, "unit": "円", "frequency": "月"}], "period": 5}},
    {"input": "インターネット使用料：金額未定", "expected": {"value": None, "period": 5}},
]

TEST_CASES_LAYOUT2 = [
    {"input": "3LDK", "expected": {"values": ["3LDK"], "period": 5}},
    {"input": "2LDK・3LDK", "expected": {"values": ["2LDK", "3LDK"], "period": 5}},
    {"input": "1LDK～3LDK", "expected": {"values": ["1LDK", "2LDK", "3LDK"], "period": 5}},
    {"input": "2LDK+S（納戸）・3LDK", "expected": {"values": ["2LDK+S", "3LDK"], "period": 5}},
    {"input": "1R～3LDK", "expected": {"values": ["1R", "1LDK", "2LDK", "3LDK"], "period": 5}},
    {"input": "2LDK+S（納戸）～3LDK(2LDK+1S(サービスルーム(N))～3LDK)", "expected": {"values": ["2LDK+S", "3LDK"], "period": 5}},
    {"input": "2LDK・3LDK(2LDK+S(シューズインクローク)・3LDK+F(ファミリークロゼット))", "expected": {"values": ["2LDK", "3LDK", "3LDK+"], "period": 5}},
    {"input": "1LDK～4LDK(1LDK・2LDK・2LDK+S(納戸)・3LDK・3LDK+S(納戸)・4LDK)", "expected": {"values": ["1LDK", "2LDK", "3LDK", "4LDK"], "period": 5}},
    {"input": "1LDK～3LDK+S（納戸）(1LDK・2LDK・3LDK・3LDK+S(納戸))", "expected": {"values": ["1LDK", "2LDK", "3LDK", "3LDK+S"], "period": 5}},
    {"input": "2LDK～3LDK (2LDK～3LDK+WIC+SIC)", "expected": {"values": ["2LDK", "3LDK"], "period": 5}},
]

TEST_CASES_AREA = [
    {"input": "56.64m2～79.2m2", "expected": {"unit": "m^2", "min": 56.64, "max": 79.2, "value": 67.92, "tsubo": 20.55, "min_tsubo": 17.13, "max_tsubo": 23.96, "period": 5}},
    {"input": "56.7m2・59.43m2", "expected": {"unit": "m^2", "value": 56.7, "tsubo": 17.15, "period": 5}},
    {"input": "63.83m2～104.42m2、 (全戸にトランクルーム面積0.22m2～0.42m2を含む)", "expected": {"unit": "m^2", "min": 0.42, "max": 104.42, "value": 52.42, "tsubo": 15.86, "min_tsubo": 0.13, "max_tsubo": 31.59, "period": 5}},
    {"input": "64.06m2～80.32m2、（トランクルーム面積0.26m2含む）", "expected": {"unit": "m^2", "min": 64.06, "max": 80.32, "value": 72.19, "tsubo": 21.84, "min_tsubo": 19.38, "max_tsubo": 24.3, "period": 5}},
    {"input": "73.99m2、(専用トランクルーム面積含む)", "expected": {"unit": "m^2", "value": 73.99, "tsubo": 22.38, "period": 5}},
    {"input": "58.75m2～77.04m2、（防災備蓄倉庫面積 0.81m2・1.80m2含む）", "expected": {"unit": "m^2", "min": 58.75, "max": 77.04, "value": 67.895, "tsubo": 20.54, "min_tsubo": 17.77, "max_tsubo": 23.3, "period": 5}},
    {"input": "69.79m2・73.99m2、(専用トランクルーム面積0.27m2・0.45m2含む)", "expected": {"unit": "m^2", "value": 69.79, "tsubo": 21.11, "period": 5}},
    {"input": "31.84m2～141.66m2、(トランクルーム面積0.97m2～2.11m2含む)", "expected": {"unit": "m^2", "min": 2.11, "max": 141.66, "value": 71.885, "tsubo": 21.75, "min_tsubo": 0.64, "max_tsubo": 42.85, "period": 5}},
    {"input": "42.88m2～208.17m2", "expected": {"unit": "m^2", "min": 42.88, "max": 208.17, "value": 125.525, "tsubo": 37.97, "min_tsubo": 12.97, "max_tsubo": 62.97, "period": 5}},
    {"input": "75m2～78.57m2、(トランクルーム面積含む)", "expected": {"unit": "m^2", "min": 75.0, "max": 78.57, "value": 76.785, "tsubo": 23.23, "min_tsubo": 22.69, "max_tsubo": 23.77, "period": 5}},
]

TEST_CASES_DATE_EXACT2 = [
    {"input": "-", "expected": {"date": None, "period": 5}},
    {"input": "2024/03/31", "expected": {"date": "2024-03-31", "period": 5}},
    {"input": "2024/06/30", "expected": {"date": "2024-06-30", "period": 5}},
    {"input": "2024/02/29", "expected": {"date": "2024-02-29", "period": 5}},
    {"input": "2025/02/28", "expected": {"date": "2025-02-28", "period": 5}},
    {"input": "2024/12/15", "expected": {"date": "2024-12-15", "period": 5}},
    {"input": "2024/03/01", "expected": {"date": "2024-03-01", "period": 5}},
    {"input": "2024/12/31", "expected": {"date": "2024-12-31", "period": 5}},
    {"input": "2025/09/27", "expected": {"date": "2025-09-27", "period": 5}},
    {"input": "2025/04/29", "expected": {"date": "2025-04-29", "period": 5}},
]

TEST_CASES_DELIVERY_DATE = [
    {"input": "即引渡可", "expected": {"type": "immediate", "period": 4}},
    {"input": "即引渡可※諸手続き完了後", "expected": {"type": "immediate", "note": "諸手続き完了後", "period": 4}},
    {"input": "2025年3月下旬予定", "expected": {"year": 2025, "month": 3, "is_planned": True, "period_text": "下旬", "estimated_date": "2025-03-25", "period": 4}},
    {"input": "2025年6月中旬予定", "expected": {"year": 2025, "month": 6, "is_planned": True, "period_text": "中旬", "estimated_date": "2025-06-15", "period": 4}},
    {"input": "2025年8月上旬予定", "expected": {"year": 2025, "month": 8, "is_planned": True, "period_text": "上旬", "estimated_date": "2025-08-05", "period": 4}},
    {"input": "2025年4月予定", "expected": {"year": 2025, "month": 4, "is_planned": True, "estimated_date": "2025-04-01", "period": 4}},
    {"input": "2025年9月末予定", "expected": {"year": 2025, "month": 9, "is_planned": True, "period_text": "末", "estimated_date": "2025-09-30", "period": 4}},
    {"input": "即引渡可※諸手続後（第1街区）、2025年3月下旬予定（第2街区）", "expected": {"type": "immediate", "note": "諸手続き完了後", "period": 4}},
    {"input": "2025年4月29日予定※完売時期によっては変更となる場合がございます。", "expected": {"year": 2025, "month": 4, "day": 29, "estimated_date": "2025-04-29", "period": 4}},
    {"input": "2026年4月中旬予定 ※2025年1月以降にご契約の方の引渡は、2026年3月上旬(予定)から変更となります。", "expected": {"year": 2026, "month": 4, "is_planned": True, "period_text": "上旬", "estimated_date": "2026-04-05", "period": 4}},
]

TEST_CASES_FLOOR = [
    {"input": "-", "expected": {"value": None, "period": 4}},
    {"input": "1階", "expected": {"value": 1, "unit": "階", "period": 4}},
    {"input": "2階", "expected": {"value": 2, "unit": "階", "period": 4}},
    {"input": "3階", "expected": {"value": 3, "unit": "階", "period": 4}},
    {"input": "5階", "expected": {"value": 5, "unit": "階", "period": 4}},
    {"input": "6階", "expected": {"value": 6, "unit": "階", "period": 4}},
    {"input": "7階", "expected": {"value": 7, "unit": "階", "period": 4}},
    {"input": "8階", "expected": {"value": 8, "unit": "階", "period": 4}},
    {"input": "10階", "expected": {"value": 10, "unit": "階", "period": 4}},
    {"input": "13階", "expected": {"value": 13, "unit": "階", "period": 4}},
]

TEST_CASES_DIRECTION = [
    {"input": "-", "expected": {"value": None, "period": 4}},
    {"input": "南", "expected": {"value": "南", "period": 4}},
    {"input": "東", "expected": {"value": "東", "period": 4}},
    {"input": "西", "expected": {"value": "西", "period": 4}},
    {"input": "北", "expected": {"value": "北", "period": 4}},
    {"input": "南東", "expected": {"value": "南東", "period": 4}},
    {"input": "南西", "expected": {"value": "南西", "period": 4}},
    {"input": "北東", "expected": {"value": "北東", "period": 4}},
    {"input": "北西", "expected": {"value": "北西", "period": 4}},
    {"input": "南北", "expected": {"value": "南北", "period": 4}},
]
...
TEST_CASES_BUILDING_STRUCTURE2 = [
    ...
    {"input": "8階/SRC10階建一部RC", "expected": {"floor": 8, "structure": "SRC", "total_floors": 10, "basement_floors": 0}},
]
...
TEST_CASES_PARKING = [
    ...
    {"input": "敷地内（1万6761円～2万951円／月）", "expected": {"availability": True, "location": "敷地内", "value": 13856, "min": 16761, "max": 20951, "unit": "円", "frequency": "月", "note": None}},
